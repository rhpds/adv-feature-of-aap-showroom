...
This chapter was meant to provide a brief introduction to Policy Enforcement in AAP. This might give you some ideas for more gardrails around your automation which go beyond the role based access control, by looking at the context of an automation job. To help you get started with creating rego policies, here a some pointers to more information:
