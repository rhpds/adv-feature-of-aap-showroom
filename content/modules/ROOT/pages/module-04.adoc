...
In the AAP UI, open menu:Automation Execution[Templates], select **Deploy Webapplication**, then:
...
. To enable the survey, while still on the **Survey** tab, switch the slider from **Survey disabled** to **Survey enabled** (it turns from grey to blue).
...
If you open menu:Automation Execution[Templates], select **Deploy Webapplication**, and open the **Team Access** tab, you will see an overview of all RBAC entries.
...
The user can view, launch, and approve, but not edit the template (there is no **Edit** button).
