...
Go to the Showroom tab **Gitea** or point your browser to {gitea_url}[window=blank].
...
* **Source Control URL**: The clone URL of your Gitea repository, {gitea_url}/{gitea_username}/{gitea_controller_project}.git
...
Open the file `/home/{bastion_ssh_user_name}/{gitea_controller_project}/apache_install.yml` in your VS Code and change something, like set `enabled: false`.
