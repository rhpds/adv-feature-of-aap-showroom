...
After the successful run, log into your {controller_url}[Ansible Automation Platform web UI,window=blank], using the user *{controller_username}* and the usual password *{controller_password}*.
