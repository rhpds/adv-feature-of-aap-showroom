...
After the successful run, log into your {controller_url}[Ansible Automation Platform web UI,window=blank], using the user *{z_ansible_controller_admin_username}* and the usual password *{controller_password}*.
