...
After the successful run, log into your {z_ansible_controller_web_ui_url}[Ansible Automation Platform web UI,window=blank], using the user *{z_ansible_controller_admin_username}* and the usual password *{z_ansible_controller_admin_password}*.
