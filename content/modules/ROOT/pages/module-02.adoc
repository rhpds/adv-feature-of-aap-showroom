...
Open **Automation Execution** and make sure that you see the configured objects and that three jobs "Source Control Update" have successfully been executed which cloned the git repositories.
