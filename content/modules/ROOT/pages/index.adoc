...
* Copy and paste in the virtual terminals offered in your favourite web browser can be finicky using keyboard combinations, but using the context menu summoned by a right mouse-click always works.
...
The lab instructions are divided into chapters, or exercises. The chapters cover a lot of ground and you might not be able to finish all of them in our limited time frame or you already know some of the areas covered. To help you choose between chapters we have divided the content into three levels:
...
TIP: You might have seen there is a Showroom tab named **>_Terminal**, this will give you a plain terminal without **VS Code Server**.
