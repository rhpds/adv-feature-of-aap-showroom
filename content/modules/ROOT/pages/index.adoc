...
In this hands-on lab, we'll introduce you to some advanced capabilities of Automation Execution so you can benefit even more from using AAP.
You'll learn how to:
...
On the right side, there are different tabs providing access to the elements of your lab, described in more details in the next chapter.
...
As hinted in the previous chapter, you can access most elements of the environment through the showroom tabs but you have the option to access the lab in separate browser tabs, too. For the access details, check the xref:lab-access.adoc[Lab Access] section.
