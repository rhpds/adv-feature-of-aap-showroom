...
* Copy and esp paste in the virtual terminals offered in your favourite web browser can be finicky using keyboard combinations, but using the context menu summoned by a right mouse-click works well in Firefox and Chrome.
...
You can also open the file in **VS Code Server** by using the navigation bar on the left labeled "Explorer" or menu:File[Open File].
