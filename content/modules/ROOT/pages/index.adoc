...
For most exercises you'll have to use the Linux commandline. You have three options:

* **VS Code Server** when an IDE is your thing
* A **Terminal** running in your browser for people familiar with Nano or Vi
* And even **SSH** if you're the Linux admin type... ;-)
...
.Click here to see the instructions for the SSH
[%collapsible]
====
