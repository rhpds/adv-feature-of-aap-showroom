...
--
+
After saving the template the **Workflow Visualizer** opens to allow you to build a workflow. You can later open the **Workflow Visualizer** again by using the button labeled btn:[Visualizer] on the template details page.
...
. Back in the main **Workflow Visualizer** view, click btn:[Save] in the upper left to save the Workflow Template.
...
Same as for a normal job template execution you can go to the **Details** tab to get more information.
