...
. Bring up your **VS Code Server** browser tab; Log in with password `{controller_password}`, if you've been logged out or never logged in before.
. In either the visual editor or in the terminal using your favorite command-line editor, create the file `/home/{ssh_username}/dyninv.sh` with the content of the Bash script shown above.
