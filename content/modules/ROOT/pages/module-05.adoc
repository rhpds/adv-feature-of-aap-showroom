...
. Open the **Sources** tab and click btn:[Create Source].
. Fill in the fields:
...
. Return to the **Sources** tab of the **Cloud inventory**.
...
After the inventory sync has finished, open menu:Automation Execution[Infrastructure > Hosts] and review the new hosts added to the **Cloud inventory**. You should see hosts matching the JSON output above.
