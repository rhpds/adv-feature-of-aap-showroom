...
To access the UI, open {controller_url}[Ansible Automation Platform,window=blank] in a new browser tab, or in Showroom click the **AAP** tab.
...
The menu lists the main components of AAP, most entries will open sub-menus when clicked, like the menu:Automation Execution[] in this example:
...
* menu:Automation Content[] unifies the Private Automation Hub into the UI, so that you can manage reusable automation content, like container images (Execution and Decision Environments) and Ansible collections.

* menu:Ansible Lightspeed[] is providing a link to get started with generative AI for AAP automation code.
...
* And finally menu:Settings[] for configuring AAP and the menu:QuickStarts[] you've already seen.
