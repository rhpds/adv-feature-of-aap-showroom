...
Login as user **lab-user** with the password **{controller_password}**. This will open the shiny new UI, let's have a look around.
...
* And finally **Settings** for configuring AAP and the **QuickStarts** you've already seen.
