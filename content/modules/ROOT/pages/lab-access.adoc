...
| VS Code | {z_vscode_web_ui_url}[window=blank] | Codeserver | {z_gitea_web_ui_username}
| Automation controller | {z_ansible_controller_web_ui_url}[window=blank] | AAP | {z_ansible_controller_admin_username}
| Gitea web UI | {z_gitea_web_ui_url}[window=blank] | n/a | {z_gitea_web_ui_username}
|===
